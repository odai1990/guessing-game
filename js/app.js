...
function askingForInput() {
    ...
    //alert((answerAfterCheck === 'yes' || answerAfterCheck === 'y') ? ('you are correct',userScoor++) : 'why do you think that i\'m not caty person!');
    ...
    //alert((answerAfterCheck === 'yes' || answerAfterCheck === 'y') ? ('you are correct',userScoor++) : 'I am 30 years old?');
    ...
    //alert((answerAfterCheck === 'yes' || answerAfterCheck === 'y') ? ('you are correct',userScoor++) : 'who do you think built this website!');
    ...
    //alert((answerAfterCheck === 'n' || answerAfterCheck === 'no') ? ('you are correct',userScoor++) : 'no i don\'t have a dual citizenship');
    ...
    // alert((answerAfterCheck === 'yes' || answerAfterCheck === 'y') ? ('you are correct',userScoor++) : 'am i look short in my pics?');
